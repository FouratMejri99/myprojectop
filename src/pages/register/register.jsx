...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await setDoc(doc(db, "marketplace", userCredential.user.uid), {
        name: name,
        email: email,
        phone: phone,
        pays: pays,
        address: address,
        matFiscal: matFiscal,
        activities: activities.endsWith(",")
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div
                className={`flex items-center gap-1 font-bold transition-all ${
                  step !== 1 && "text-secondary"
                }`}
              >
                <span
                  className={`flex items-center justify-center min-w-8 h-8 border-2 border-accent rounded-full text-lg ${
                    step === 1 && "bg-primary"
                  } `}
                >
                  1
              ...
              <div
                className={`pr-1 transition-all ease-out overflow-hidden ${
                  step !== 1
                    ? "max-h-0 opacity-0 duration-0 hidden"
              ...
              >
                <div className={`border-l-2 border-primary ml-4 pl-2 py-2`}>
                  <div className="grid gap-2">
                    <div className="grid gap-1">
                      ...
                      <Input
                        ...
                        } h-16 lg:h-12 rounded-2xl hover:border-foreground focus:border-none transition-all`}
                    ...
                    <div className="grid gap-1">
                      {paysError && (
                        <p className="text-destructive">{paysError}</p>
                      )}
                    ...
                    <div className="grid gap-1">
                      ...
                      <span className="text-xs">
                        fournir le lien de Google Maps indiquant votre adresse
                      </span>
                    </div>
                  </div>
                  <div className="flex justify-end">
                    <Button
                      type="button"
                      className="w-1/2 mt-5 font-bold uppercase tracking-wider h-16 lg:h-12 rounded-2xl bg-[#242323] text-white hover:text-primary-foreground"
                      onClick={() => handleNext()}
                    >
                      Suivant
                    </Button>
              ...
              {/* second step */}
              <div
                className={`mt-2 flex items-center gap-1 font-bold transition-all ${
                  step !== 2 && "text-secondary"
                }`}
              >
                <span
                  className={`flex items-center justify-center min-w-8 h-8 border-2 border-accent rounded-full text-lg ${
              ...
              >
                <div className={`border-l-2 border-primary ml-4 pl-2 py-2`}>
                  <div className="grid gap-4">
                    <div className="grid gap-1">
                      {matFiscalError && (
                        <p className="text-destructive">{matFiscalError}</p>
                      )}
                      <Input
                        id="fiscal"
                        ...
                        disabled={isLoading}
                        className={`${
                          matFiscalError ? "border-destructive" : ""
                        } h-16 lg:h-12 rounded-2xl hover:border-foreground focus:border-none transition-all`}
                    ...
                    <div className="grid gap-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-2 gap-2">
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <Label htmlFor="Mobilier et Rangement">
                            Mobilier et Rangement
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            id="Décoration Murale et Sol"
                            onCheckedChange={(check) => {
                              handleActivitiesChange(
                                "Décoration Murale et Sol",
                                check
                              );
                            }}
                          />
                          <Label htmlFor="Décoration Murale et Sol">
                            Décoration Murale et Sol
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            id="Éclairage et Luminaires"
                            onCheckedChange={(check) => {
                              handleActivitiesChange(
                          ...
                          />
                          <Label htmlFor="Éclairage et Luminaires">
                            Éclairage et Luminaires
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            id="Plantes et Végétation"
                            onCheckedChange={(check) => {
                              handleActivitiesChange(
                          ...
                          />
                          <Label htmlFor="Plantes et Végétation">
                            Plantes et Végétation
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            id="Textiles et Accessoires"
                            onCheckedChange={(check) => {
                              handleActivitiesChange(
                          ...
                          />
                          <Label htmlFor="Textiles et Accessoires">
                            Textiles et Accessoires
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            id="Essentiels pour Espace de Travail"
                            onCheckedChange={(check) => {
                              handleActivitiesChange(
                          ...
                          />
                          <Label htmlFor="Essentiels pour Espace de Travail">
                            Essentiels pour Espace de Travail
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            id="Décoration Extérieure et Saisonnière"
                            onCheckedChange={(check) => {
                              handleActivitiesChange(
                          ...
                          />
                          <Label htmlFor="Décoration Extérieure et Saisonnière">
                            Décoration Extérieure et Saisonnière
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            id="Cuisine et Salle à Mange"
                            onCheckedChange={(check) => {
                              handleActivitiesChange(
                                "Cuisine et Salle à Mange",
                                check
                              );
                            }}
                          />
                          <Label htmlFor="Cuisine et Salle à Mange">
                    ...
                    <div className="grid gap-1">
                      ...
                      {dateStartError && (
                        <p className="text-destructive">{dateStartError}</p>
                      )}
                    ...
                    <div className="mt-7 flex gap-2">
                      <Button
                        variant="outline"
                        type="button"
                        className="w-full font-bold uppercase tracking-wider h-16 lg:h-12 rounded-2xl"
                        onClick={() => handlePrev()}
                      >
                        Précédent
                      </Button>
                      <Button
                        type="button"
                        className="w-full font-bold uppercase tracking-wider h-16 lg:h-12 rounded-2xl bg-[#242323] text-white hover:text-primary-foreground"
                        onClick={() => handleNext()}
                      >
                        Suivant
                      </Button>
                  ...
                  <div className="grid gap-4">
                    ...
                    <div>
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          id="terms"
                          onCheckedChange={(v) => setTermConditionCheck(v)}
                        />
                        <label
                          htmlFor="terms"
                        ...
                        >
                          Accepter les{" "}
                          <TermConditionDialog
                            message={"règles et conditions"}
                          />{" "}
                          de Tnker Pro
                        </label>
                      </div>
                      {termConditionCheckError && (
                        <p className="text-destructive">
                          {termConditionCheckError}
                        </p>
                      )}
